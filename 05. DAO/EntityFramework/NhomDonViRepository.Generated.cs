...
{   
	public partial class NhomDonViRepository
	{
		private IRepository<NhomDonVi> _repository {get;set;}
		public IRepository<NhomDonVi> Repository
		{
			get { return _repository; }
			set { _repository = value; }
		}
		
		public NhomDonViRepository(IRepository<NhomDonVi> repository, IUnitOfWork unitOfWork)
    	{
    		Repository = repository;
			Repository.UnitOfWork = new EFUnitOfWork(); 
    	}

		public List<NhomDonVi> GetList(Expression<Func<NhomDonVi, bool>> where)
        {
            try
            {
                IEnumerable<NhomDonVi> lResult;
                if (where != null)
                {
		...
		public List<NhomDonVi> GetList(Expression<Func<NhomDonVi, bool>> where, int pageIndex, int pageSize, ref int totalItem, Func<NhomDonVi, object> orderCol = null, bool isDecending = true)
        {
            try
            {
                IEnumerable<NhomDonVi> lResult;
		...
		public NhomDonVi GetById(int id)
        {
            ...
            {
                OutputLog.WriteOutputLog(ex);
                return new NhomDonVi();
            }
        }
        public NhomDonVi GetByFilter(Expression<Func<NhomDonVi, bool>> where)
        {
            try
            {
                Repository.Save();
		...
		public bool CheckByFilter(Expression<Func<NhomDonVi, bool>> where)
        {
            try
            {
                Repository.Save();
        ...
        public bool Add(NhomDonVi entity)
        {
		...
		public bool Add(List<NhomDonVi> lentity)
        {
            using (TransactionScope scope = new TransactionScope())
            {
                try
        ...
        public bool Update(NhomDonVi entity)
        {
            try
            {
		...
		public bool Update(List<NhomDonVi> lentity)
        {
            using (TransactionScope scope = new TransactionScope())
            {
                try
