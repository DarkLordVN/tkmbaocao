...
namespace TKM.WebApp.Controllers
{
    public class HomeController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            //    }
            //    itemLi.Append("<li class=\"media text-right pt-3\"><a class=\"d-inline-block\" href=\"/ThongBao?tab=1\">Xem thêm <i class=\"fal fa-angle-double-right\"></i></a></li>");
            //    html += itemLi;
            //}
            //else
            //{
            //    html = "Không có thông báo mới...";
            //}
            //ViewBag.ThongBao = html;
            ////html = "Không có lịch mới...";
            //html = "";
            //for (int i = 2; i > -2; i--)
            //{
            ...
            //}
            //html += "<li class=\"list-group-item px-0\"><a href=\"/LichLanhDao/IndexView\">Xem thêm <i class=\"fal fa-angle-double-right\"></i></a></li>";
            //ViewBag.LichLanhDao = html;
            return View();
        }
        ...
        public ActionResult VanBanDuThaoDiChart(string typeUser = "", string capBac = "", int userloginid = 0, int donviloginid = 0)
        {
            ...
            var tab_daphathanh = 0;
            var lstDataChart = new List<double>();
            //DataTable tableCV = _vanBanDuThaoDiService.GetVanBanDuThaoDiDashBoard(ref tab_chuaphathanh, ref tab_daphathanh, SessionInfo.CurrentUser.ID, SessionInfo.CurrentUser.DonViID, typeUser, SessionInfo.CurrentUser.CapBac);
